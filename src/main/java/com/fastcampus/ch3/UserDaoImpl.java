...
//@Component - @Controller, @Repository, @Service, @ControllerAdivce
@Repository
...
//        PreparedStatement pstmt = null;
        ...
        // try-with-resources - since jdk7 이게 제일 좋은 방법.
        // 괄호 안에서 생성한 객체들은 수동으로 close해주지 않아도 자동으로 close된다. (메모리 누수 이점)
        try (
